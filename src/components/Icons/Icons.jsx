  ...
  >
    <defs>
      <linearGradient id="searchGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <stop
          offset="100%"
          style={{ stopColor: "currentColor", stopOpacity: 0.4 }}
        />
      </linearGradient>
  ...
  >
    <defs>
      <linearGradient id="userGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop
          offset="0%"
          style={{ stopColor: "currentColor", stopOpacity: 0.9 }}
        />
        <stop
          offset="100%"
...
export const GraduationIcon = ({ className = "", size = 24 }) => (
  ...
  >
    ...
    <path
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      filter="url(#graduationShadow)"
    />
    <path
      d="M2 10V19C2 19.5304 2.21071 20.0391 2.58579 20.4142C2.96086 20.7893 3.46957 21 4 21H20C20.5304 21 21.0391 20.7893 21.4142 20.4142C21.7893 20.0391 22 19.5304 22 19V10"
      stroke="currentColor"
      strokeWidth="1.75"
      strokeLinecap="round"
      strokeLinejoin="round"
    ...
    />
    <path
      d="M6 21V12.5L12 15.5L18 12.5V21"
      stroke="currentColor"
      strokeWidth="1.75"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const LogOutIcon = ({ className = "", size = 20 }) => (
  ...
  >
    ...
    <path
      d="M7 17L12 12M12 12L7 7M12 12H2"
      stroke="currentColor"
      strokeWidth="1.75"
      strokeLinecap="round"
      strokeLinejoin="round"
    ...
    />
    <path
      d="M2 4H10C11.1046 4 12 4.89543 12 6V18C12 19.1046 11.1046 20 10 20H2"
      stroke="currentColor"
      strokeWidth="1.75"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const SettingsIcon = ({ className = "", size = 20 }) => (
  ...
  >
    ...
    />
    <path
      d="M16.6362 9.63624C16.6447 9.82956 16.6447 10.0241 16.6362 10.2174C16.5682 10.9395 16.2983 11.6316 15.8595 12.2062C15.4207 12.7808 14.8307 13.2148 14.1618 13.4559C13.493 13.6971 12.7714 13.7353 12.0821 13.5662L10.9821 15.3662C10.8652 15.5507 10.7079 15.7079 10.5234 15.8248C10.3388 15.9417 10.132 16.0152 9.91809 16.04C9.70419 16.0648 9.48877 16.0403 9.28768 15.9684C9.08659 15.8964 8.90532 15.779 8.75709 15.6256L6.91459 13.7831C6.76118 13.6349 6.64378 13.4536 6.57184 13.2525C6.4999 13.0514 6.47537 12.836 6.50019 12.6221C6.52501 12.4082 6.59848 12.2014 6.71537 12.0158C6.83227 11.8303 6.98952 11.671 7.17409 11.5521L8.97409 10.4521C8.80495 9.76281 8.84319 9.04117 9.08434 8.37234C9.3255 7.7035 9.75951 7.11347 10.3341 6.67468C10.9087 6.23588 11.6008 5.96595 12.3229 5.89796C12.5162 5.88946 12.7108 5.88946 12.9041 5.89796"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const TrashIcon = ({ className = "", size = 20 }) => (
  ...
  >
    <defs>
      ...
      <filter id="trashShadow" x="-20%" y="-20%" width="140%" height="140%">
        <feDropShadow
          ...
          dy="2"
          stdDeviation="1.5"
          floodColor="rgba(185, 28, 28, 0.25)"
        />
      </filter>
    </defs>
    <path
      d="M6 7L7.5 19.5C7.6 20.3 8.3 21 9.1 21H14.9C15.7 21 16.4 20.3 16.5 19.5L18 7H6Z"
      fill="url(#trashGrad)"
    ...
    <rect
      ...
      height="3"
      rx="1.5"
      fill="url(#trashLidGrad)"
      filter="url(#trashShadow)"
    />
    <path
      d="M9.5 4V2.5C9.5 1.7 10.2 1 11 1H13C13.8 1 14.5 1.7 14.5 2.5V4H9.5Z"
      fill="url(#trashLidGrad)"
    />
    <path
      d="M9.5 10V18"
